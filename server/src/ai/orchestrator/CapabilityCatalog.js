...
const CAPABILITIES = [
  ...
  { id: 'contracts.count.awaiting_signature', domain: 'contracts', queryTypes: ['count', 'list'], toolName: 'count_documents_in_signing_platform', defaultArgs: {}, resultType: 'signing_summary', modelAllowed: false },
  ...
  // Workflows / tasks
  { id: 'workflows.summary', domain: 'workflows', queryTypes: ['summary', 'progress'], toolName: 'query_reports_summary', defaultArgs: { reportType: 'tasks', period: 'this_month' }, resultType: 'report_summary', modelAllowed: false },
  { id: 'workflows.tracker_tasks', domain: 'workflows', queryTypes: ['list', 'filter'], toolName: 'query_tasks', defaultArgs: { filters: { sourceType: 'LEGAL_TRACKER' }, limit: 20 }, resultType: 'task_summary', modelAllowed: false },
  { id: 'workflows.manual_tasks', domain: 'workflows', queryTypes: ['list', 'filter'], toolName: 'query_tasks', defaultArgs: { filters: { sourceType: 'MANUAL_WORKFLOW' }, limit: 20 }, resultType: 'task_summary', modelAllowed: false },
  { id: 'workflows.unassigned_tasks', domain: 'workflows', queryTypes: ['list'], toolName: 'query_tasks', defaultArgs: { filters: { unassignedOnly: true }, limit: 20 }, resultType: 'task_summary', modelAllowed: false },
  { id: 'workflows.overdue_tasks', domain: 'workflows', queryTypes: ['list', 'count'], toolName: 'list_overdue_tasks', defaultArgs: { mine_only: false, limit: 10 }, resultType: 'task_summary', modelAllowed: false },
  { id: 'workflows.due_today', domain: 'workflows', queryTypes: ['list'], toolName: 'query_tasks', defaultArgs: { filters: { dueRange: 'today' }, limit: 20 }, resultType: 'task_summary', modelAllowed: false },
  ...
  { id: 'tasks.by_source', domain: 'tasks', queryTypes: ['list'], toolName: 'query_tasks', defaultArgs: { filters: {}, limit: 20 }, resultType: 'task_summary', modelAllowed: false },
  ...
  { id: 'tasks.team_workload', domain: 'tasks', queryTypes: ['summary'], toolName: 'get_task_summary', defaultArgs: { mine_only: false }, resultType: 'task_summary', modelAllowed: false },
  ...
  { id: 'reports.workflow_progress', domain: 'reports', queryTypes: ['progress', 'summary'], toolName: 'query_reports_summary', defaultArgs: { reportType: 'tasks', period: 'this_month' }, resultType: 'report_summary', modelAllowed: false },
